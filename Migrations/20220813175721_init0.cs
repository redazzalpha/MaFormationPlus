    ...
    public partial class init0 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionUtilisateurs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SessionUtilisateurs_AspNetUsers_StagiaireId",
                        column: x => x.StagiaireId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SessionUtilisateurs_Sessions_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionUtilisateurs_SessionId",
                table: "SessionUtilisateurs",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionUtilisateurs_StagiaireId",
                table: "SessionUtilisateurs",
                column: "StagiaireId");
        }
