        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Sessions_Utilisateur_ConseillerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParcoursesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModuleParcours", x => new { x.ModulesId, x.ParcoursesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModuleParcours_Parcours_ParcoursesId",
                        column: x => x.ParcoursesId,
                        principalTable: "Parcours",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionStagiaire", x => new { x.SessionsId, x.StagiairesId });
                    table.ForeignKey(
                        name: "FK_SessionStagiaire_Sessions_SessionsId",
                        column: x => x.SessionsId,
                        principalTable: "Sessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionStagiaire_Utilisateur_StagiairesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModuleParcours_ParcoursesId",
                table: "ModuleParcours",
                column: "ParcoursesId");

            migrationBuilder.CreateIndex(
                name: "IX_Modules_UniteId",
                table: "Modules",
                column: "UniteId");

            migrationBuilder.CreateIndex(
                name: "IX_Sessions_ConseillerId",
                table: "Sessions",
                column: "ConseillerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionStagiaire_StagiairesId",
